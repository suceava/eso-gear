...
const updateData = async () => {
    try {
        const js = await fs.readFile(FILE_NAME);
        console.log(js);
    } catch (err) {
        console.error(err);
    }
...
// set to true to crawl site and generate inital list
// set to false to load existing eso-sets.js file and update data
const CRAWL_SITE = true;
if (CRAWL_SITE) {
    fetchData();
} else {
    updateData();
